...
PRICING: Book direct at knobview.com for best price — saves significantly vs Airbnb which charges 15%+ in fees. Cleaning fee $175 flat. NC taxes 12.75% total (6.75% sales + 6% Buncombe County occupancy). Min stay 2 nights. Check-in 4pm, checkout 11am. Secure Stripe payments. PAYMENT SCHEDULE: 25% deposit charged automatically at booking, remaining 75% balance charged automatically 14 days before check-in (same card on file). A temporary $500 damage hold is placed on the card 24 hours before check-in and released after checkout pending inspection.

CANCELLATION: Flexible policy matching our Airbnb listing. Full refund (minus cleaning fee) if cancelled 24+ hours before check-in. Within 24 hours of check-in, guest is charged for the first night plus one additional night; remaining nights refunded. If cancelled after check-in, all remaining unused nights are refunded in full.
